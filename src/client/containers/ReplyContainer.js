...
class ReplyContainer extends Component {
    ...
    render() {
        const { handleTextChange, handleFormSubmit, loadReplyForm, turnOnModifyMode,
            turnOnDeleteMode, turnOffDeleteMode, handleDelete, clear } = this;
                ...
                { !onPending &&
                    <Fragment>
                        <ReplyList 
                            ...
                            clear={clear}
                            onModifyMode={turnOnModifyMode}
                            unshown={unshown}
                            onDeleteMode={turnOnDeleteMode}
                            deleteMode={deleteMode}
                            offDeleteMode={turnOffDeleteMode}
...
const mapDispatchToProps = (dispatch) => ({
    ...
    turnOffDisplay: (id) => dispatch(replyActions.turnOffDisplay(id)),
